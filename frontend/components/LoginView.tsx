          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl max-w-md w-full relative text-slate-100">
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">Google Account Sign-In</h4>
                  <p className="text-[11px] text-slate-400">Choose or type your Google Account details</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <form onSubmit={handleGoogleSubmit} className="mt-4 space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-300 mb-1">Full Name (Optional)</label>
                <input
                  type="text"
